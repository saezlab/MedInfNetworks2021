...
## Download and explore data from GEO - Gene Expression Omnibus

## Note

If you find trouble trying to run anything when coding, remember that the
documentation and/or Google are your best friends.
...
+:===============:+:===============:+:======================================:+
| `biomaRt`       | Bioconductor    | Get molecular annotation for features  |
|                 |                 | (gene, proteins, etc)                  |
+-----------------+-----------------+----------------------------------------+
| `Biobase`       | Bioconductor    | Handle Expression-Sets (gene           |
|                 |                 | expression data)                       |
+-----------------+-----------------+----------------------------------------+
...
matrix. This matrix contains measurements of the gene-level expression. Each row corresponds to a gene and each column corresponds to a sample.

**Metadatafor samples and features**: There are two `data.frame`s
containing metadata for samples and features. Phenotype information and complementary information for the probes.
...
To access this information, you can use two functions from the `Biobase` package:
...
expression of the gene. For this, we need to create a vector that maps each probe
to its corresponding gene
